"""Vue cuisine — filtre de risque sémantique : récit prioritaire à traiter."""

import streamlit as st

from pipeline.ui.charts import graphique_recits, graphique_recits_risque
...
def afficher(donnees: dict) -> None:
    ...
    recit_prioritaire = max(
        recits, key=lambda recit: recit.get("score_risque", 0), default={}
    )
